<script setup>
import { ref, defineProps, createApp, onMounted } from 'vue'
        ...
        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              >
              Nombre:
              <input class="form-control" type="text" name="name" v-model="newClient.name" id="name" required>
              Apellidos:
              <input class="form-control" type="text" name="lastname" v-model="newClient.lastname" id="lastname" required>
              Email:
              <input class="form-control" type="email" name="email" v-model="newClient.mail" id="email" required><br><br>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul class="list-group mt-3">
                <li class="list-group-item d-flex align-items-center" v-for="clientes in cliente" :key="clientes.id"> 
                  <button class="btn btn-danger btn-sm" @click="deleteClient(clientes.id)">Eliminar</button>
                  &nbsp;
                  &nbsp;
